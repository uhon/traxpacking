...
(function (e) {
    e.widget("ui.autocomplete", {
        ...
        _create: function () {
            ...
            this.menu = e("<ul></ul>").addClass("autocompleteComboboxMenu").addClass("ui-autocomplete").appendTo("body", b).menu({
                focus: function (c, d) {
...
(function (d) {
    ...
    d.widget("ui.tabs", {
        ...
        _setOption: function (c, e) {
            if (c == "selected") this.options.collapsible && e == this.options.selected || this.select(e);
            else {
                this.options[c] = e;
                this._tabify()
            }
    ...
    d.extend(J.prototype, {
        ...
        parseDate: function (a, b, c) {
            ...
            for (var e = (c ? c.shortYearCutoff : null) || this._defaults.shortYearCutoff, f = (c ? c.dayNamesShort : null) || this._defaults.dayNamesShort, h = (c ? c.dayNames : null) || this._defaults.dayNames, i = (c ? c.monthNamesShort : null) || this._defaults.monthNamesShort, g = (c ? c.monthNames : null) || this._defaults.monthNames, k = c = -1, l = -1, u = -1, j = false, o = function (p) {
                ...
                s++
            }, s = 0, z = 0; z < a.length; z++) if (j) if (a.charAt(z) == "'" && !o("'")) j = false;
            else r();
        ...
        formatDate: function (a, b, c) {
            ...
            var i = function (o) {
                ...
                l = "",
                u = false;
            if (b) for (var j = 0; j < a.length; j++) if (u) if (a.charAt(j) == "'" && !i("'")) u = false;
            else l += a.charAt(j);
...
function (f) {
    ...
    f.fn.extend({
        ...
        _show: f.fn.show,
        show: function (c) {
            if (!c || typeof c == "number" || f.fx.speeds[c]) return this._show.apply(this, arguments);
            else {
                var a = j.apply(this, arguments);
                a[1].mode = "show";
        ...
        toggle: function (c) {
            if (!c || typeof c == "number" || f.fx.speeds[c] || typeof c == "boolean" || f.isFunction(c)) return this.__toggle.apply(this, arguments);
            else {
                var a = j.apply(this, arguments);
                a[1].mode = "toggle";
                return this.effect.apply(this, a)
