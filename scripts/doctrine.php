...
set_include_path(implode(PATH_SEPARATOR, array(
    ...
    realpath(APPLICATION_PATH . '/../library/doctrine2-common/lib'),
    realpath(APPLICATION_PATH . '/../library/doctrine2-orm/lib'),
    realpath(APPLICATION_PATH . '/../library/doctrine2-dbal/lib'),
    get_include_path(),
)));
